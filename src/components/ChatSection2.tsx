...
const ChatSection2: React.FC<ChatSectionProps> = ({
  userName,
  gameManager,
}) => {
  ...
  const sendMessage = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    gameManager.sendChatMessage(newMessage);
  ...
  useEffect(() => {
    ...
    gameManager.onChatMessage = (sender, text) => {
      const msg = {
        sender,
        text,
      };
    ...
    return () => {
      gameManager.onChatMessage = undefined;
    };
  }, [messages]);
